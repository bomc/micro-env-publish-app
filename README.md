...
> Die `externalTrafficPolicy` mit dem Wert `Local` bedeutet, dass Requests nur an lokale Endpoints weitergeleitet werden. Es wird niemals Datenverkehr an andere Knoten weitergeleitet, wobei die ursprüngliche Client-IP-Adresse beibehalten wird. 
